...
<head>
	...
	<title>Selamat Datang | PLN</title>
...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/dips.png" class="brand">
			...
			<ul>
				<li>
					<a href="<?php echo URL; ?>/dashboard">
						<img class="icon" src="<?php echo AST; ?>/img/home.jpeg" alt=""> Home
					</a>
				</li>
				<li>
				...
				<li>
					<a href="<?php echo URL; ?>/users">
						<img class="icon" src="<?php echo AST; ?>/img/dipa.jpeg" alt=""> Users
					</a>
				</li>
				<li>
					<a href="<?php echo URL; ?>/dashboard/logout">
						<img class="icon" src="<?php echo AST; ?>/img/log.jpeg" alt=""> Logout
					</a>
				</li>
			</ul>
		</nav>
	...
	<main>
		...
		<footer>
			Copyright &copy; 2022 - <?php echo date('Y'); ?>. Designed by MRS. DIVA AULIA💓
		</footer>
	</main>
